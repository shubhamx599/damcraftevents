...
const SERVICES = [
  ...
  },
  {
    ...
    poster:
      "https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fGV2ZW50fGVufDB8fDB8fHww",
    color: "#ec4899",
  ...
  },
  {
    ...
    poster:
      "https://images.unsplash.com/photo-1561489396-888724a1543d?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fGV2ZW50fGVufDB8fDB8fHww",
    color: "#06b6d4",
    description: "Creating buzz in market spaces",
    features: [
      "Market Campaigns",
      "Public Engagement",
      "Road Shows",
      ...
      {!isLoading && (
        <div
          className={`absolute inset-0 flex items-center justify-center z-10 transition-all duration-200 ${
            isPlaying
              ? "opacity-0 group-hover:opacity-80 bg-black/20"
              : "bg-black/40"
          }`}
        >
          <div
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundColor: service.color || "rgba(255,255,255,0.04)" }}
      />

      <div
        className={`grid grid-cols-1 gap-6 items-center ${
          isReverse
            ? "lg:grid-cols-2 lg:grid-flow-col-dense lg:auto-cols-fr"
            : "lg:grid-cols-2 lg:auto-cols-fr"
        }`}
      >
