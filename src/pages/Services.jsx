...
const Services = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[var(--bg-dark)] via-[var(--bg-darker)] to-[var(--bg-dark)] text-[var(--text-primary)] overflow-hidden">
      {/* Animated Background */}
        ...
        <div className="relative z-10 text-center max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.p
              ...
              className="text-xl sm:text-2xl text-[var(--text-secondary)] max-w-4xl mx-auto leading-relaxed"
            >
            ...
            <motion.p
              ...
              className="text-lg text-[var(--text-secondary)]/80 max-w-2xl mx-auto leading-relaxed"
            >
              ...
              >
                ...
                <div className={`space-y-6 ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <h3 className="text-2xl lg:text-4xl font-bold text-[var(--text-primary)]">
                        {service.title}
                      </h3>
                    </div>
                  </div>
                ...
                <div className={`relative ${index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}`}>
                  <motion.div
                    ...
                    className={`rounded-3xl p-6 bg-gradient-to-br ${service.bgGradient} border border-[var(--border-glass)] shadow-lg`}
                  >
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      {Object.entries(service.stats).map(([key, value]) => (
                        <motion.div
                          key={key}
                          whileHover={{ scale: 1.05 }}
                          className="text-center p-4 rounded-xl bg-[var(--bg-dark)] border border-[var(--border-glass)] hover:border-[var(--text-primary)]/20 shadow-sm"
                        >
      ...
      {/* Process Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[var(--bg-section-tint)]">
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {PROCESS_STEPS.map((step, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="relative p-6 rounded-3xl bg-[var(--bg-dark)] border border-[var(--border-glass)] hover:border-[var(--text-primary)]/20 transition-all duration-500 h-full shadow-md">
                  ...
                  <div className="mt-8">
                    <div className={`w-14 h-14 border border-[var(--border-glass)] hover:border-[var(--text-primary)]/20 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
              ...
              >
                <div className="flex flex-col sm:flex-row items-start gap-6">
                  ...
                  <div className="flex-1 text-center sm:text-left">
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--border-glass)] text-[var(--text-primary)] border border-[var(--border-glass)] text-sm font-medium">
          ...
          <div className="space-y-4">
            {FAQ_DATA.map((faq, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-[var(--bg-dark)] border border-[var(--border-glass)] rounded-2xl overflow-hidden shadow-sm"
              >
                <button
                  onClick={() => toggleFaq(index)}
                  className="w-full px-6 py-6 text-left flex items-center justify-between gap-4 hover:bg-[var(--border-glass)] transition-all duration-300"
                >
